      ...
      <div className='navigation-panel'>
        ...
        {signedIn && (
          <>
            ...
            <ColumnLink transparent to='/followed_tags' icon='tag' iconComponent={HashtagIcon} activeIconComponent={HashtagActiveIcon} text={intl.formatMessage(messages.followed_tags)} />
            <FollowRequestsLink />
